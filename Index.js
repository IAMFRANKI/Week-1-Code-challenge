...
function calculateDemeritPoints(){
    ...
    if(speed <= speedLimit){
        ...
        if(demeritPoints >= 12){
            speedMessage = "Lincence Suspended";
        }else{
...
function calculateNetSalary(){
    ...
    const nhif = nhifRates[Math.ceil(basiSalary / 10000)];
    ...
    document.getElementById("net-salary").innerHTML = `Gross Salary: ${grossSalary} <br>payee: ${payee}<br>NHIF DEduction`
